...
export class Backend implements backendInterface {
    ...
    async createRoom(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getRoomMessages(arg0: string, arg1: bigint, arg2: bigint): Promise<Array<Message>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRoomMessages(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRooms(): Promise<Array<RoomDetails>> {
        if (this.processError) {
            try {
    ...
    async getRoomsOfUser(arg0: Principal): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRoomsOfUser(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
